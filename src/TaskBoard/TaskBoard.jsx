...
//     console.log("Drag started:", task, columnId);
//     setDraggedTask(task);
...
//     console.log("Dropped:", draggedTask, columnId, index);
//     e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* New Task Form */}
        {isAdding && (
          <div className="mb-6 sm:mb-8 border-2 border-indigo-200 rounded-lg shadow">
            <div className="p-4 sm:p-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                  <button
                    onClick={addNewTask}
                    className="flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded"
                  >
                    Add Task
                  </button>
                  <button
                    onClick={() => setIsAdding(false)}
                    className="flex items-center justify-center border border-gray-300 text-gray-700 py-2 px-4 rounded hover:bg-gray-100"
                  >
                    Cancel
                  </button>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {Object.entries(columns).map(([columnId, column]) => (
            ...
            >
              ...
              <div className="min-h-[150px] sm:min-h-[200px] space-y-3">
                {column.items.map((task, index) => (
                  <div
                    key={task.id || task._id}
                    draggable
